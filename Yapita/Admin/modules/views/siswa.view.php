...
<div class="row">
    <div class="col-lg-12">
        <div class="form-group">
            <a href="<?php echo PATH; ?>?page=siswa&&action=insert"
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <?php
                                if($siswa->images) {
                            ?>
                            <img src="../public/images/siswa/<?php echo $siswa->images; ?>"
                                 style="width: 50px;" alt="<?php echo $siswa->images; ?>">
                            <?php
                                } else {
                            ?>
                            <img src="../resources/images/no_user.jpg"
                                 style="width: 50px;" alt="<?php echo $siswa->images; ?>">
                            <?php
                                }
                            ?>
                        ...
                        <td>
                            ...
                            echo SITE_URL; ?>?page=siswa&&action=detail&&id=<?php 
                            echo $siswa->id_siswa; ?>">Detail</a>
                            <a class="btn btn-warning btn-sm" href="<?php 
                            echo SITE_URL; ?>?page=siswa&&action=update&&id=<?php 
                            echo $siswa->id_siswa; ?>">Edit</a>
                            <a class="btn btn-danger btn-sm" href="<?php 
                            echo SITE_URL; ?>?page=siswa&&action=delete&&id=<?php 
                            echo $siswa->id_siswa; ?>" onclick="return confirm
                            ('Are you sure delete this data?');">Detail</a>
                        </td>
                    </tr>
                    <?php
                        $no++;
